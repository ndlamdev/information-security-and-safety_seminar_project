...
public class SelectAlgorithmGenerateKeyComponent extends JPanel implements Observer {
    ...
    private JPanel panelSizeKey, panelAlgorithm;
    ...
    public AlgorithmKey getAlgorithmKey() {
        return new AlgorithmKey((String) jbcAlgorithms.getSelectedItem(), Integer.parseInt(jbcSizeKey.getSelectedItem() == null ? "0" : (String) jbcSizeKey.getSelectedItem()));
    }
