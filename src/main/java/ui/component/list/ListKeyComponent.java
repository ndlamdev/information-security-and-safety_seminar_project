...
package main.java.ui.component.list;

import main.java.ui.component.key.ButtonKey;
...
public class ListKeyComponent extends JPanel implements Observer {
    ...
    private List<String> getListKey(String path) {
        ...
        Arrays.stream(Objects.requireNonNull(folder.listFiles(File::isDirectory))).forEach(it -> {
